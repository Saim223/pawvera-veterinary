      ...
      >
        ...
        >
          <div className="notch-card-sm relative bg-brand-700 px-4 py-3 text-xs leading-relaxed text-paper shadow-lg">
            {doctor.bio}
            <span className="absolute left-1/2 top-full h-3 w-3 -translate-x-1/2 -translate-y-1.5 rotate-45 bg-brand-700" 
  aria-hidden="true" />
          </div>
        </div>

        {/* max=0 disables the 3D tilt, and scale=1 disables TiltCard's own
            hover-scale too — both rotation and scale render text at
            non-integer sub-pixel sizes, which browsers anti-alias as soft/
            blurry. The lift/border/shadow hover effect below (on the
            article itself) is the only hover motion this card needs. */}
        <TiltCard max={0} scale={1} className="h-full">
          <article className="notch-card group relative flex h-full flex-col gap-5 border border-line bg-surface p-6 shadow-xs
  transition-[box-shadow,transform,border-color] duration-300 hover:-translate-y-1.5 hover:border-accent-400 hover:shadow-lg">
            <div
              aria-hidden="true"
            ...
            <div className="flex items-start justify-between gap-3">
              <div className="flex items-center gap-3.5">
                <div className="relative shrink-0">
                  ...
                  <span
                    aria-hidden="true"
                    className="absolute -bottom-1 -right-1 flex h-5 w-5 scale-75 items-center justify-center rounded-full border-2
  border-surface bg-brand-500 text-paper opacity-0 shadow-sm transition-all duration-300 group-hover:scale-100 group-hover:opacity-100"    
                  >
              ...
              {doctor.availableToday && (
                <span className="flex shrink-0 items-center gap-1.5 rounded-full bg-brand-50 px-2.5 py-1 text-[0.68rem] font-bold
  text-brand-600">
            ...
            <div className="flex flex-wrap items-center gap-x-4 gap-y-1.5 text-sm text-ink-soft">
              <span className="inline-flex items-center gap-1 rounded-full bg-accent-100 px-2.5 py-1 text-xs font-semibold
  text-accent-600">
            ...
            <div className="mt-1 flex items-center gap-3">
              <Link
                ...
                className="flex-1 rounded-md border border-line px-4 py-2.5 text-center text-sm font-semibold text-brand-700
